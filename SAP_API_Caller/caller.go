...
import (
	...
	"io/ioutil"
	"net/http"
	sap_api_output_formatter "sap-api-integrations-sales-territory-reads/SAP_API_Output_Formatter"
	"strings"
	"sync"
...
func (c *SAPAPICaller) SalesTerritoryCollection(iD string) {
	data, err := c.callSalesTerritorySrvAPIRequirementSalesTerritoryCollection("SalesTerritoryCollection", iD)
	if err != nil {
		c.log.Error(err)
		return
	}
